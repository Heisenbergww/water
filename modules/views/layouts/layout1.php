...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="" style="font-weight:700;font-family:Microsoft Yahei">后台管理</a>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                <li><a href="<?php echo yii\helpers\Url::to(['home/list'])?>">轮播列表</a></li>
                <li><a href="<?php echo yii\helpers\Url::to(['home/add'])?>">添加轮播</a></li>
                </ul>
            </li>      
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['news/add'])?>">添加新闻</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['news/list'])?>">新闻列表</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['known/add'])?>">添加常识</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['known/list'])?>">常识列表</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
...
<!--                </a>-->
<!--                <ul class="submenu">-->
<!--                    <li><a href="--><?php //echo yii\helpers\Url::to(['column/aboutus'])?><!--">编辑about us</a></li>-->
<!--                    <li><a href="--><?php //echo yii\helpers\Url::to(['column/list'])?><!--">栏目列表</a></li>-->
<!--                </ul>-->
<!--            </li>-->
