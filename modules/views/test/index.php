        ...
        <div class="row-fluid login-wrapper">
            ...
            <?php $form = ActiveForm::begin([
                ...
                <div class="span4 box">
                    ...
                    <?php echo $form->field($model, 'adminuser')->textInput(['class' => 'span9',"placeholder"=>"管理员名称"]); ?>
                    <?php echo $form->field($model, 'adminemail')->textInput(['class' => 'span9',"placeholder"=>"管理员邮箱"]); ?>
                    <?php echo $form->field($model, 'adminpass')->passwordInput(['class' => 'span9',"placeholder"=>"管理员密码"]); ?> 
                    <?php echo $form->field($model, 'repass')->passwordInput(['class' => 'span9',"placeholder"=>"管理员确认密码"]); ?>         
